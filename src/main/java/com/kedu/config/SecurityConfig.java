...
public class SecurityConfig {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors -> cors.configurationSource(request -> {
                    ...
                    config.setAllowedOrigins(Arrays.asList("http://192.168.1.10:3000", "http://localhost:3000", "http://192.168.1.36:3000", "http://192.168.1.11:3000", "http://192.168.1.19:3000" ,"http://172.30.1.29:3000"));
